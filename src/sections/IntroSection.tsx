      ...
      <div className="flex flex-col items-center gap-5 md:flex-row">
        ...
        <div className="flex w-full flex-col items-center gap-2 md:w-[352px] md:shrink-0 md:items-start">
          <div className="flex w-full flex-col gap-0.5">
            <p className="w-full font-serif text-[clamp(16px,calc(16px_+_(100vw_-_375px)_*_0.00299),17.94px)] leading-none text-center md:text-left text-[#eaeaea]">
              {hero.greeting}
            </p>
            <h1 className="w-full bg-linear-to-r from-[#f1f1f1] to-[#7ebde8] bg-clip-text font-serif text-center md:text-left text-4xl leading-none text-transparent md:text-5xl md:leading-none">
              {hero.name}
            </h1>
          </div>
